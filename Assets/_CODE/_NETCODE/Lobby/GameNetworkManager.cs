...
namespace _CODE._NETCODE.Lobby
{
    public class GameNetworkManager : MonoBehaviour
    {
        ...
        public Steamworks.Data.Lobby? currentLobby { get; private set; } = null;
        ...
        private async void SteamFriends_OnGameLobbyJoinRequested(Steamworks.Data.Lobby _lobby, SteamId _steamId)
        {
        ...
        private void SteamMatchmaking_OnLobbyGameCreated(Steamworks.Data.Lobby _lobby, uint _ip, ushort _port, SteamId _steamId)
        {
        ...
        private void SteamMatchmaking_OnLobbyInvite(Friend _steamId, Steamworks.Data.Lobby _lobby)
        {
            Debug.Log($"Invite from {_steamId.Name}");
        }

        private void SteamMatchmaking_OnLobbyMemberLeave(Steamworks.Data.Lobby _lobby, Friend _steamId)
        {
        ...
        private void SteamMatchmaking_OnLobbyMemberJoined(Steamworks.Data.Lobby _lobby, Friend _steamId)
        {
            Debug.Log("member join");
        }

        private void SteamMatchmaking_OnLobbyEntered(Steamworks.Data.Lobby _lobby)
        {
        ...
        private void SteamMatchmaking_OnLobbyCreated(Result _result, Steamworks.Data.Lobby _lobby)
        {
